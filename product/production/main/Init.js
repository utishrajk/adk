        ...
        require([
            ...
            require([
                ...
                resourceDirectoryFetch.fetch({
                    ...
                    url: 'http://172.16.112.153:8080/resource/resourcedirectory',
                    success: function() {
                ...
                resourceDirectoryWriteback.fetch({
                    ...
                    url : 'http://172.16.112.153:8080/resource/write-health-data/resourcedirectory',
                    success: function() {
                ...
                resourceDirectoryPickList.fetch({
                    ...
                    url : 'http://172.16.112.153:8080/resource/write-pick-list/resourcedirectory',
                    success: function() {
                ...
                function fetchFacilityMonikers() {
                    ...
                    facilityMonikers.fetch({
                        ...
                        url: 'http://172.16.112.153:8080/resource/locations/facility-monikers',
                        success: function() {
